...
namespace knl
{
  ...
  */
  namespace io
  {
     ...
     * This function loads the data in binary from the file specified by "path".
     * The data buffer must be pre allocated and able to hold num_elements * bytes_elem
     * bytes.
     *
     ...
     * This function creates a file specified by the "path" parameter and tries
     * to write the contents of the "data" buffer. If successful, the function
     * returns true.
     *
